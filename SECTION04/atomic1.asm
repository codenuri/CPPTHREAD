; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30031.0 
	...
	TITLE	A:\CPP\05_CONCURRENT\ONLINE\SECTION04\atomic1.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CRT$XCU	SEGMENT
?m$initializer$@@3P6AXXZA DD FLAT:??__Em@@YAXXZ		; m$initializer$
CRT$XCU	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File A:\CPP\05_CONCURRENT\ONLINE\SECTION04\atomic1.cpp
_TEXT	SEGMENT
_t1$ = -24						; size = 8
_t2$ = -16						; size = 8
_t3$ = -8						; size = 8
...
; 19   : //            lock inc x
; 20   : //        }
; 21   :         InterlockedIncrement(&x);

	lock	 inc	 DWORD PTR ?x@@3JA
...
;	COMDAT ??__Fm@@YAXXZ
text$yd	SEGMENT
??__Fm@@YAXXZ PROC					; `dynamic atexit destructor for 'm'', COMDAT
	push	ebp
	mov	ebp, esp
	mov	ecx, OFFSET ?m@@3Vmutex@std@@A		; m
	call	??1mutex@std@@QAE@XZ
	pop	ebp
	ret	0
??__Fm@@YAXXZ ENDP					; `dynamic atexit destructor for 'm''
text$yd	ENDS
; Function compile flags: /Odtp
; File A:\CPP\05_CONCURRENT\ONLINE\SECTION04\atomic1.cpp
;	COMDAT ??__Em@@YAXXZ
text$di	SEGMENT
??__Em@@YAXXZ PROC					; `dynamic initializer for 'm'', COMDAT
...
; 6    : std::mutex m;
	...
	push	OFFSET ??__Fm@@YAXXZ			; `dynamic atexit destructor for 'm''
	call	_atexit
	add	esp, 4
	pop	ebp
	ret	0
??__Em@@YAXXZ ENDP					; `dynamic initializer for 'm''
text$di	ENDS
; Function compile flags: /Odtp
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File C:\Program Files (x86)\Microsoft Visual Studio\2019\Preview\VC\Tools\MSVC\14.29.30031\include\mutex
